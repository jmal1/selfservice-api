...
**Expected result:** Crucible records a run and shows its status. Only one assessment can run for a lab at a time, and runs are limited to three per hour.
...
**Expected result:** You can tell which checks passed and see the feedback your instructor chose to share.

Ask your instructor if a required playlist is missing, a result reports an error without a useful next step, or the expected lab task is unclear.
