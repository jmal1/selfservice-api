...
| **Password** | `REPLACE_WITH_BUILD_PASSWORD` (the standard build password) | *Don't leave blank* — always set a password here |
...
### The standard build login (`Student`/`REPLACE_WITH_BUILD_PASSWORD`)
