...
pwsh ./scripts/local-verify.ps1 -RemoteHelm -RemoteHost jmal@k3s.example.test
```
...
Do not retry with `REPLACE_WITH_BUILD_PASSWORD` on a customized student clone. That is a
