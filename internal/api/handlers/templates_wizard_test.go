...
func TestWizardStatePopulatesBuildVMFields(t *testing.T) {
	...
	if got.DefaultPassword != "REPLACE_WITH_BUILD_PASSWORD" {
		t.Errorf("DefaultPassword = %q; want REPLACE_WITH_BUILD_PASSWORD", got.DefaultPassword)
	}
...
func TestNormalizeUnattendConfig(t *testing.T) {
	...
	realistic := `{"hostname":"kali-build","username":"student","password":"REPLACE_WITH_BUILD_PASSWORD","locale":"en_US.UTF-8","time_zone":"America/New_York","apt_proxy":"","extra_pkgs":["nmap","wireshark"]}`
